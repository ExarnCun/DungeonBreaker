 ...
 * 'every "living thing" in the game should be an entity (like monsters,
 * players, etc.)'
 *
 */
public abstract class Entity implements Renderable, Collisionable, Tickable {
	...
	/**
	 * direction where the entity is looking (in degrees) <br>
	 * 0 = up
	 * 90 = right;
	 * 180 = down;
	 * 270 = left;
	 ...
	 * @param sender
	 *            The object using the item
	 * @param item
	 *            The item used
	 * @param damage
	 *            ammount of damage caused to this entity
	 */
	 ...
	 * 
	 * @param x
	 *            how far the entity should move horizontally
	 * @param y
	 *            how far the entity should move vertically
	 * @param world
