...
/**
 * 
 * 'Super-container' of Everything the game provides (Items, Entities,
 * Listeners, ...)
 * 
 * @author ExarnCun
 *
...
public abstract class World extends JFrame {
	...
	public void paint(Graphics g) {
		...
		GGraphics.drawImage(GBackground, 0, 0, getWidth(), getHeight(), null); // Draw
																				// Background

		render(GGraphics);

		g.drawImage(NextFrame, 0, 0, getWidth(), getHeight(), null); // Draw
																		// next
																		// Frame
																		// on
																		// JFrame
	...
	/**
	 * invoked every time when the {@link #paint(Graphics) paint-method} is
	 * invoked
	 * 
	 * @param g
